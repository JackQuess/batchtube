...
export const Footer: React.FC<FooterProps> = ({ t }) => {
  return (
    <footer className="border-t border-white/5 bg-[#0b0b10] py-6 sm:py-8 mt-auto relative z-10">
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 md:px-6 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-2 sm:gap-3 text-xs text-neutral-500">
        {/* Left: Copyright */}
