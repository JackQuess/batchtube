...
export const Footer: React.FC<FooterProps> = ({ onOpenLegal, t }) => {
  return (
    <footer className="border-t border-white/5 bg-[#0b0b10] py-6 sm:py-8 mt-auto relative z-10">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 sm:gap-4 text-xs text-gray-500">
        {/* Left: Copyright */}
