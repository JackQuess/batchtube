...
export const VideoCard: React.FC<VideoCardProps> = ({
  ...
  const displayTitle = video.title && video.title.trim() ? video.title : t.metadataUnavailable;
  const displayChannel = video.channel && video.channel.trim() ? video.channel : t.metadataUnavailable;
  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-grow gap-2">
        <h3 className="text-white font-medium text-sm sm:text-base line-clamp-2 leading-snug" title={displayTitle}>
          {displayTitle}
        </h3>
